...
Original file is located at
    https://colab.research.google.com/drive/1_TiOkQ8SCUATLLGYHKyEq0Wtna5YuZMg

# Checking the GPU, if it is suitable for libraries that are used in this project.
"""
...
#Utilizing argparse for configuration 
def parse_args():
    parser = argparse.ArgumentParser()
    parser.add_argument('--raf_path', type=str, default='/content/drive/MyDrive/datasets/CASME2', help='Raf-DB dataset path.')
    ...
    parser.add_argument('--workers', default=10, type=int, help='Number of data loading workers (default: 4)') #Normally, the default value of workers is 4 but we increase it to 10 to get faster training.
    parser.add_argument('--epochs', type=int, default=7000, help='Total training epochs.')
    parser.add_argument('--drop_rate', type=float, default=0, help='Drop out rate.')
    return parser.parse_args()

#Implementing RafDataSet to integrate our data into a PyTorch data pipline
class RafDataSet(data.Dataset):
    def __init__(self, raf_path, phase,num_loso, transform = None, basic_aug = False, transform_norm=None):
        ...
        #Reading the columns from excel file 'CASME2-coding-20190701.xlsx'
        #Excel file includes action units for each dataset folder
        ...
        d=0
        e=0
        #Using aligned images for training/testing
        #The variables are assigned the corresponding values from the lists using tuple unpacking.
        for (f,sub,onset,apex,offset,label_all,label_au) in zip(File_names,Subject,Onset_num,Apex_num,Offset_num,Label_all,Label_au):
            ...
            #It checks if label_all is equal to one of the labels ('happiness', 'repression', 'disgust', 'surprise', 'others').
    ...
    def __getitem__(self, idx):
        ...
        #Sampling strategy for testing set
        else:
            onset = self.file_paths_on[idx]
            apex = self.file_paths_apex[idx]
            offset = self.file_paths_off[idx]
...
#In case, to use pretranied model weights            
"""
...
#Computing a loss value based on predicted and true labels
...
#Resetting the command-line arguments and removing the sys module from memory.
import sys
sys.argv=['']
del sys

#Defining a PyTorch module called MMNet
class MMNet(nn.Module):
    def __init__(self):
        ...
        self.main_branch = resnet18_pos_attention(pretrained=False)
...
def run_training():
    ...
    args = parse_args()
    #In case working with pratrained model weights
    #Loading Imagenet weights that trained with ResNet
    """imagenet_pretrained = True
    if not imagenet_pretrained:
        for m in res50.modules():
            initialize_weight_goog(m)

    if args.pretrained:
        print("Loading pretrained weights...", args.pretrained)
        pretrained = torch.as_tensor(args.pretrained)
        pretrained_state_dict = pretrained['state_dict']
        model_state_dict = res50.state_dict()
        loaded_keys = 0
        total_keys = 0
        ...
        res50.load_state_dict(model_state_dict, strict=False)"""
    ...
    #Data normalization for both testing set
    ...
    LOSO = ['12','25','16','3','23','4','2','18','22','17','7','26','11','1','19','21','10','24','9','8','14','20','13','5','12','6']
    ...
    for subj in LOSO:
        ...
        for i in range(1, 75):
            ...
            label_all,label_au) in enumerate(train_loader):
        ...
        print("[..........%s] correctnum:%d . summary:%d   " % (subj, max_corr, val_dataset.__len__()))
