...
#In case working with pretrained model weights.
"""
...
class ResNet(nn.Module):
    ...
    def _forward_impl(self, x,POS):
        ...
        #Fusion of motion pattern feature and position embeddings
        x=x+POS
...
def resnet50_pos_attention(pretrained=False, progress=True, **kwargs):
    
    return _resnet('resnet50', CABlock, [1, 1, 1, 1], pretrained, progress,
                   **kwargs)

def resnet34_pos_attention(pretrained=False, progress=True, **kwargs):
    
    return _resnet('resnet34', CABlock, [1, 1, 1, 1], pretrained, progress,
                   **kwargs)

def resnet101_pos_attention(pretrained=False, progress=True, **kwargs):
    
    return _resnet('resnet101', CABlock, [1, 1, 1, 1], pretrained, progress,
                   **kwargs)

def resnet152_pos_attention(pretrained=False, progress=True, **kwargs):

    return _resnet('resnet152', CABlock, [1, 1, 1, 1], pretrained, progress,
                   **kwargs)
